...
public class ValidationComboBox extends Region {
	...
	public ValidationComboBox(ValidationType type) {

		validationProperty = new ValidationProperty(type);
		initComponent();
	}

	public ValidationComboBox(ValidationType type, String promptText) {
	...
	public ValidationComboBox(ValidationType type, String promptText, ValidationProperty agency) {

		validationProperty = new ValidationProperty(type);
		initComponent();

		textBox.setPromptText(promptText);
		validationProperty.bindBidirectional(agency);
	...
	private void initComponent() {
		...
		tip.textProperty().bind(
				Bindings.format("Agency Code: %s\nAgency Name: %s",
						validationProperty.get().codeProperty(),
						validationProperty.get().nameProperty()));
